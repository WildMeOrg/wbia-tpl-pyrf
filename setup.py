...
LICENSE = 'BSD'
DESCRIPTION = 'PyRF - Random Forest / Hough Voting Detection Algorithm'
...
KWARGS = OrderedDict(
    ...
    # know that the cmake installed files belong in the pyrf module and
    ...
    package_dir={
        'pyrf': 'pyrf',
        # Note: this requires that PYRF_LIB_INSTALL_DIR is set to pyrf/lib
